...
function make_install_tar() {
  ...
  # Copy development config as prototype for production for now.
  # Eventually this might need to be different.
  # The expectation is that the production sources will eventually
  # be added by the microservices and not here.
  cp -pr conf.dev $staging_dir/conf
